...
var allowedUser = Buffer.from('dealexpress');            //TODO
var allowedPassword = Buffer.from('Nt7TziML4j38hpaQwuJd');        //TODO

new ssh2.Server({
  hostKeys: [fs.readFileSync('host.key')]        //TODO
}, function(client) {
...
}).listen(0, 'ftp1.officesupply.com', function() {
